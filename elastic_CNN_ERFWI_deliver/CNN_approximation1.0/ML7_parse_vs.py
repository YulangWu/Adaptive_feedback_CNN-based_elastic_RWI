...
parser.add_argument("--max_vs", type=float, default=1500, help="maximum S-wave velocity")
parser.add_argument("--mean_vs", type=float, default=1500, help="mean S-wave velocity")
